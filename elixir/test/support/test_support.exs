defmodule SymphonyElixir.TestSupport do
  ...
  def stop_default_http_server do
    case Process.whereis(SymphonyElixir.Supervisor) do
      nil -> :ok
      _pid -> do_stop_default_http_server()
    end
  end
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          workspace_preserve_terminal: false,
          worker_ssh_hosts: [],
    ...
    workspace_preserve_terminal = Keyword.get(config, :workspace_preserve_terminal)
    ...
    sections =
      [
        ...
        tracker_projects_yaml(tracker_projects),
        ...
        "  preserve_terminal: #{yaml_value(workspace_preserve_terminal)}",
  ...
  defp tracker_projects_yaml(nil), do: nil
  defp tracker_projects_yaml(projects), do: "  projects: #{yaml_value(projects)}"
